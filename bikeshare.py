...
def get_filters():
    ...
    # TO DO: get user input for type of filter (month, day, both, or not at all)
    while 1 == 1 :
        filter_type = input("\nWould you like to filter  the data by month, day, both or all?\n").lower()  
        if filter_type in ["month", "day", "both", "all"]:
            break
        else:
            print(invalid_inputs)

    # TO DO: verify the filter_type
    if filter_type == 'month':
        # TO DO: get user input for month (all, january, february, ... , june)
        while 1 == 1 :
            month = input("\nEnter the name of the month:\njanuary, february, march,"
                " april, may, june to filter by, or \"all\" to apply no month filter\n").lower()
            day = 'all'
            ...
            # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
                while 1 == 1 :
                    day = input("\nEnter the name of the day: \nmonday, tuesday, wednesday, thursday,"
                     " friday, saturday, sunday of week to filter by, or \"all\" to apply no day filter\n").lower()
                    month = 'all'
